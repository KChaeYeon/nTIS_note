...
> **상태:** 10개 후보 도출 및 FINES 평가 완료 (2026-06-11) — 지도교수 확인 후 최종 1~2개 확정 예정
...
| 3 | 경골신경 TIS Rat 방광 조절 | 4 | 5 | 5 | 3 | 5 | **4.45** | A | ⭐⭐⭐ |
...
#### 후보 3. 경골신경 TIS in vivo — Rat 과민성 방광 조절 ⭐⭐⭐
...
- [ ] cystometry 장비 보유 여부 (후보 3 선택 시 필수)
- [ ] IACUC/IRB 진행 가능한 동물 프로토콜 범위
- [ ] 3-phase 하드웨어 완성 예상 시점
- [ ] 지도교수 관심: 경부 미주신경 vs. 경골신경 어느 쪽 우선?
...
- [ ] cystometry 장비 보유 여부 (후보 3 선택 시)
- [ ] Student A와 ICG 프로토콜 공유 미팅 가능 여부 (후보 1 선택 시)
- [ ] IACUC/IRB 진행 가능한 동물 프로토콜 범위
- [ ] 3-phase 하드웨어 완성 예상 시점 (Track B 후보들)
- [ ] 지도교수 방향성: glymphatic 고위험고보상 vs. 경골신경 안정적 고임팩트
