...
경골신경 TIS의 초기 in vivo 근거이나, **최적 전극 배치·파라미터·만성 효과·PTNS 직접 비교**는 미해결 → `03_gaps/gap_analysis.md`의 G-TN1(in vivo 검증), G-TN2(vs PTNS)로 직접 연결. 본 연구(경골신경 nTIS)가 확장·검증하려는 baseline이다.
